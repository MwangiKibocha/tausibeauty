...
INSERT INTO stylists (stylist_name, stylist_email, stylist_image)
VALUES
  ('Wendy Kimani', 'wendy@gmail.com', 'stylist1.jpg'),
  ('Trizah Ochieng', 'trizah@gmail.com', 'stylist2.jpg'),
  ('Tasha Kinyua', 'tasha@gmail.com', 'stylist3.jpg'),
  ('Timmo KE', 'timmo@gmail.com', 'stylist4.jpg');

INSERT INTO `bookings` (`id`, `first_name`, `last_name`, `Email`, `Phone`, `service` `stylist`, ,, `date`, `time`,) VALUES
('1,','Vin', 'Doe', 'vin.doe@example.com', '555-1234', 'Hair', 'John', '2023-03-15', '10:00:00'),
('2','James', 'Smith', 'james.smith@example.com', '555-5678', 'Makeup', 'Emily', '2023-03-16', '14:00:00' ),
--
-- Dumping data for table `appointment`
--

INSERT INTO `appointment` (`Id`, `FirstName`, `LastName`, `Email`, `PhoneNumber`, `Stylist`, `Category`, `Service`, `AptDate`, `AptTime`, `Message`, `ApplyDate`) VALUES
...
INSERT INTO services (serviceName, Description, cost, image_url)
VALUES
('makeup', 'Professional makeup application for any occasion', 50.00, '../image/image/makeup.jpeg'),
('facials', 'Customized facial treatments to rejuvenate your skin', 80.00, '../image/image/facials.jpeg'),
('hair', 'Haircut, color, and styling services for men and women', 65.00, '../image/image/hair.jpg'),
('pedicure', 'Relaxing foot treatments to soothe and pamper your feet', 40.00, '../image/image/pedicure.jpg'),
('manicure', 'Nail care and polish services to keep your hands looking beautiful', 35.00, '../image/image/manicure.jpg');
