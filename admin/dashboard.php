...
<html>
    <head>
    <li><a href="../index.html"><button class="signup btn btn-default">logout</button></a></li>
    </head>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                                <?php $query1=mysqli_query($con,"Select * from services");
                        ...
                        <div class="col-lg-3 col-6">
                            <!-- small box -->
                            <div class="small-box bg-info">
                                <?php $query2=mysqli_query($con,"Select * from stylists");
                                $totalstylist=mysqli_num_rows($query2);
                                ?>
                                <div class="inner">
                                    <h3><?php echo $totalstylist;?></h3>
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                            <?php
                                $query4=mysqli_query($con,"select * from bookings");
                                ...
                                <a href="./search_appointment.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
