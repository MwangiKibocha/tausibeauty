          ...
          <div class="card-body col-md-12">
            ...
            { 
              ...
              <table class="table table-bordered"> 
                ...
                <tbody>
                  <?php
                  $ret=mysqli_query($con,"select * from  bookings where  first_name like '%$sdata%' || last_name like '%$sdata%' || phone_number like '%$sdata%' || services like '%$sdata%' || stylists like '%$sdata%'");
