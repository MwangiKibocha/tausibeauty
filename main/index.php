  ...
  height: 25px;
	...
	<div class="form-container">
		<form method="post" action="appointments.php">
			...
			<p class="booking-info"> Booking fee is ksh 100 that will be discounted on paying after service<br> Please enter a valid MPESA Number below</p>
			<div class="form-group">
  <div class="phone-input">
    <label for="pay_number">Phone Number:</label>
    <div class="phone-input-flex">
      <input type="tel" name="pay_number" id="pay_number" required>
    </div>
  </div>
  <div class="form-row">
	...
	<script>
		const phoneInput = document.getElementById("pay_number");
