...
$loggedInUserEmail = $_SESSION['uid'];
?>
<!DOCTYPE html>
<html>
...
<body>
<li><a href="../main/index.php"> Back to Booking </a></li>
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php
                            $ret=mysqli_query($con,"select * from bookings where email='$loggedInUserEmail' ORDER BY booking_date ASC");
                          $cnt=1;
